...
1. Clone the repository:
   ```
   git clone https://github.com/Yunchen-Cai/MATLAB-Image-Processing-Grayscale.git  # Replace with your repo URL
...
### Running the Code
1. **Main Script**: Run `run_me5405.m` to execute the full pipeline for both images.
